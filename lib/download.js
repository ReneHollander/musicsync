...
module.exports.fetchPlaylist = async function (data_path, name, playlist_url) {
    ...
    let {stdout} = await execFile(youtubeDlPath, ['-j', '--flat-playlist', playlist_url], {
        cwd: data_path,
    ...
    await execFile(youtubeDlPath, [
        ...
        '--restrict-filenames',
        playlist_url
    ], {cwd: data_path, maxBuffer: 10 * 1024 * 1024});
    ...
    for (let info_file of info_files) {
        ...
        tracks[index] = new Track(audio_path, info, stats.size);
    }
